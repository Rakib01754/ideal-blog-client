            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
                        ...
                        >
                            {pages.map((page) => (
                                <MenuItem key={page.text} component={RouterLink} to={page.link} onClick={handleCloseUserMenu}>
                    ...
                    <Box sx={{ flexGrow: 1, justifyContent: 'flex-end', alignItems: 'center', display: { xs: 'none', md: 'flex' } }}>
                        {pages.map((page) => (
                            <Button
                                ...
                                sx={{ my: 2, fontWeight: '700', color: 'black', display: 'block' }}
                            >
                                {page.text}
                            </Button>
                        ))}
                            ...
                            <Box sx={{ flexGrow: 0 }}>
                                ...
                                >
                                    {settings.map((setting) => (
                                        <MenuItem key={setting.text} onClick={handleCloseUserMenu} component={RouterLink} to={setting.link}>
